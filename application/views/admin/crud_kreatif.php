      ...
      <div class="col-sm-12 p-0">
        <div class="main-header">
          ...
          <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/kreatif/'.$links2); ?>"> <?php echo $header; ?></a>
            </li>
      ...
      <div class="col-sm-12">
        ...
        <div class="card">
          ...
          <div class="card-block">
            <?php echo  form_open_multipart('admin/kreatif/'.$action.'/'.$jenis); ?>
                    ...
                    for ($i=1; $i <$n_konten ; $i++) { ?>
                      <div class="col-md-4 col-xs-12" id="<?php echo 'finput'.$i; ?>" style="margin-bottom:5px;">
                        <input class="form-control" type="file" id="<?php echo 'foto['.$i.']'; ?>" name="<?php echo 'foto[]'; ?>" onchange="PreviewImage('<?php echo "foto[".$i."]"; ?>','<?php echo "prevFoto[".$i."]"; ?>','<?php echo "#oldFoto".$i; ?>');">
                          ...
                          <img src="<?php echo base_url('assets/images/kreatif/'.str_replace('.', '_thumb.', $foto_galeri[$i])); ?>" class="form-control" id="<?php echo 'prevFoto['.$i.']'; ?>" style="height: 200px; width: 100%;" alt="Foto Galeri">
              ...
              <div class="row" style="margin-top: 1rem;">
                ...
                <div class="col-md-8">
                  ...
                  <a href="<?php echo site_url('admin/kreatif/'.$this->uri->segment(4)); ?>" class="btn btn-primary waves-effect waves-light m-r-10"><i class="icofont icofont-arrow-left"></i><span class="m-l-10"> Kembali</a>
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>
