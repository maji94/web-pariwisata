            ...
            <li class="dropdown notification-menu">
               ...
               <ul class="dropdown-menu">
                  ...
                  <li class="bell-notification">
                     <a href="javascript:;" class="media">
                        <span class="media-left media-icon">
                           <img class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-1.png" alt="User Image">
                        </span>
                  ...
                  <li class="bell-notification">
                     <a href="javascript:;" class="media">
                        <span class="media-left media-icon">
                           <img class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-2.png" alt="User Image">
                        </span>
                        <div class="media-body">
                  ...
                  <li class="bell-notification">
                     <a href="javascript:;" class="media">
                        <span class="media-left media-icon">
                           <img class="img-circle" src="<?php echo base_url(); ?>assets/images/avatar-3.png" alt="User Image">
                        </span>
                        <div class="media-body">
