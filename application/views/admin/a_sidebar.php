    ...
    <ul class="sidebar-menu">
      ...
      <li class="<?php if ($link == 'media') {
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'artikel' or $link3 == 'artikel') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'foto' or $link3 == 'foto') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'video' or $link3 == 'video') {
                        echo 'active';
                      } ?>">
      ...
      <li class="<?php if ($link == 'kreatif') {
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'komunitas' or $link3 == 'komunitas') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'event' or $link3 == 'event') {
                        echo 'active';
                      } ?>">
      ...
      <li class="<?php if ($link == 'atraksi') {
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'alam' or $link3 == 'alam') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'budaya' or $link3 == 'budaya') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'museum' or $link3 == 'museum') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'kuliner' or $link3 == 'kuliner') {
                        echo 'active';
                      } ?>">
      ...
      <li class="<?php if ($link == 'akomodasi') {
                    echo "active";
                  } ?> treeview">
        <a class="waves-effect waves-dark" href="#!">
          <i class="icon-map"></i>
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'hotel' or $link3 == 'hotel') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'restoran' or $link3 == 'restoran') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'transportasi' or $link3 == 'transportasi') {
                        echo 'active';
                      } ?>">
      ...
      <li class="<?php if ($link == 'layanan') {
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'unduh' or $link3 == 'unduh') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'request' or $link3 == 'request') {
                        echo 'active';
                      } ?>">
      ...
      <li class="<?php if ($link == 'tentang') {
        ...
        <ul class="treeview-menu">
          <li class="<?php if ($link2 == 'struktur' or $link3 == 'struktur') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'galeri' or $link3 == 'galeri') {
                        echo 'active';
                      } ?>">
          ...
          <li class="<?php if ($link2 == 'profil' or $link3 == 'profil') {
                        echo 'active';
                      } ?>">
