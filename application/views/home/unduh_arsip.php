...
<section id="one" class="wrapper style2">
	<div class="inner">
		...
		<div class="box">
			...
			<p>Berikut ini adalah halaman yang dapat digunakan pengunjung untuk mencari dan mendownload dokumen terkait Dinas Pariwisata Provinsi Bengkulu. Pengunjung bisa mencari dokumen dengan mengetik nama dokumnen yang diinginkan pada kolom "Search". Jika dokumen yang diinginkan tidak tersedia, pengunjung bisa mengirim pesan ke admin dengan cara mnegisi formulir permintaan dokumen yang ada di halaman <strong><a href="<?php echo site_url('layanan/request'); ?>">PERMINTAAN DOKUMEN</a></strong> berikut.</p>
