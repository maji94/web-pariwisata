    ...
    <div class="grid-style">
      <div>
        <div class="box" style="background-color: transparent;">
          <div class="content">
            <header class="align-center">
              <a href="https://www.instagram.com/disparprovbengkulu" target="_blank" style="text-decoration: unset;">
                <h2>Instagram</h2>
              </a>
            </header>
      ...
      <div>
        <div class="box" style="background-color: transparent;">
          <div class="content">
            <header class="align-center">
              <a href="https://www.youtube.com/channel/UCfuQwOndCYSrjrNfBFx0ugQ" target="_blank" style="text-decoration: unset;">
                <h2>YouTube</h2>
              </a>
            </header>
          ...
          <div class="box">
            ...
            <div class="content">
              <header class="align-center">
                ...
                <a href="<?php echo site_url('media/galeri/' . $d->id); ?>" style="text-decoration: unset;">
